...
def user_line(cal, user, year, month):
    ...
    for month_date in cal.itermonthdates(year, month):
        if month_date.month == month:
            a(f'<td id="{user}-{month}-{month_date.day}" class="cal_day text-center')
...
def holiday_line(cal, year, month):
    ...
    for d in cal.itermonthdates(year, month):
        if d.month == month:
            ...
            if d in other_hdays:
                a(' other_holiday"><div class="holiday_line">')
                a(f'{other_hdays.get(d)}')
            elif d in be_hdays:
                a(' holiday"><div class="holiday_line">')
                a(f'{be_hdays.get(d)}')
                ...
                a(' weekend"><div class="holiday_line">')
                a(' ')
            else:
                a('">&nbsp;\n')
            a('</div></td>')
