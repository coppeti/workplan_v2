...
def admin_emails():
    """Returns an email list of all users who have a permission level equal to or greater than SUPERVISOR."""
    admins = CustomUser.objects.filter(role__gte=CustomUser.SUPERVISOR)
