...
urlpatterns = [
    ...
    path('events-mine/', events_mine, name="events_mine"),
    path('htmx/events_list_mine/', events_list_mine, name="events_list_mine"),
    path('htmx/event-swap/<pk>/', event_swap, name="event_swap"),
